...
function CategoryList(props) {
    ...
    const columns = [
        ...
        { title: 'N de police', width: 120, key: '8', dataIndex: "" },
        { title: 'Date Emission', width: 120, key: '9', dataIndex: "" },
    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                footer={[
                    <div>
                        <Button loading={singleLoader} className="text-white bg-warning" style={{ textAlign: "left" }} onClick={() => { printSingleAttestations("jaune"); activeSingleBtnLoader() }}>Attestation </Button>
            ...
            {/* -===================== */}
            <Modal
                title="Modifier une ligne d'attestation"
                ...
                footer={[
                    <div>
                        <Button type="primary" onClick={() => { activeModal() }}>Modifier</Button>
                        <Button type="danger" onClick={() => { annuler() }}>Annuler</Button>
                    </div>
                ]}
            >   <p>Numero de police</p>
                <Input type="text" name='text' placeholder="Numero de police" /><br /><br />
                <p>Date d'emission</p>
                <Input type="text" name='text' placeholder="Date emission" /><br /><br />
                <p>Assuré</p>
                <Input type="text" name='text' placeholder="Assuré"  /><br/><br/>
                <p>Marque</p>
                <Input type="text" name='text' placeholder="Marque" /><br/><br/>
                <p>Imatriculation</p>
                <Input type="text" name='text' placeholder="Immatriculation" /><br/><br/>
                <p>Usage</p>
                <Input type="text" name='text' placeholder="Usage"  /><br/><br/>
                <p>Genre</p>
                <Input type="text" name='text' placeholder="Genre"  />

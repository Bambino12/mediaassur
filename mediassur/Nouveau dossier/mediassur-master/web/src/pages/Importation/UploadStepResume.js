                        ...
                        <div className="col-12">
                            <div className="w-100 p-4 ">
                                <div className="row p-0 ">
                                    ...
                                    <div className="col-4">
                                        <h6 style={{float:"left"}}>
                                            Date d'effet : <strong>{new Date(currentFileAttestation.startDate).toLocaleDateString("fr-FR") }</strong>
                                        </h6>
                                    </div>
                                    <div className="col-4">
                                        <h6 style={{float:"left"}}>
                                            Echéance : <strong>{new Date(currentFileAttestation.endDate).toLocaleDateString("fr-FR") }</strong>
                                        </h6>
                                    </div>
                                </div>
                            </div>

...
@Entity
@Table(name = "lotsAutre")
public class LotAutre extends UserDateAudit {

    @Id
    @GeneratedValue(generator = "lots_id_seq", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(
            name = "lotsAutre_id_seq",
            sequenceName = "lotsAutre_id_seq",
            allocationSize = 50
    )
    private Integer id;
    ...
    public LotAutre(Integer assureId, Integer assureurId, String numeroPolice, Date startDate, Date endDate, String fileName) {
    ...
    public LotAutre(Integer assureId, Integer assureurId, String numeroPolice, Date startDate, Date endDate, String fileName, Short statusJaune, Short statusCedeao) {
        this.assureId = assureId;
        this.assureurId = assureurId;
        this.numeroPolice = numeroPolice;
        this.startDate = startDate;
